...
public class Registration {
	...
	//private static final String AppConstants = null;
		...
		public String registerUser(String firstName, String lastName, 
			...
			eleUtil.waitForElementVisible(this.firstName, AppConstant.MEDIUM_DEFAULT_WAIT);
			...
			String userRegSuccessMesg = 
					eleUtil.waitForElementVisible(userRegSuccMessg, AppConstant.MEDIUM_DEFAULT_WAIT).getText();
