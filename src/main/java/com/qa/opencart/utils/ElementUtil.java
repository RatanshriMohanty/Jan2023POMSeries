...
public class ElementUtil {
	...
	private final int DEAFULT_TIME_OUT = 5;
	...
	public  WebElement getElement(By locator) {
		...
		element = waitForElementVisible(locator, DEAFULT_TIME_OUT);
	...
	public  void search(String searchKey, By searchLocator , String suggName , By suggestions) throws InterruptedException
	{
		doSendKeys(searchLocator, suggName);
		Thread.sleep(3000);
...
// Actions class Utils
	...
	public void multiLevelMenuChildMenuHandle(By parentMenuLocator, String level2LinkText,
		...
		WebElement level = getElement(parentMenuLocator);
		
		Actions act = new Actions(driver);
		
		act.moveToElement(level).build().perform();
		Thread.sleep(1000);
...
doClick(By.linkText(level4LinkText));	
	...
	public  void alertAccept(int timeOut , String value)
	{
	...
	{
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(intervalTime));
		return wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(locator));
	}
...
public  String waitForTitleIsAndCapture(String titleVal, int timeOut)
{
...
public  String waitForTitleAndCapture(String titleVal, int timeOut)
{
